...
/**
 * واجهة استعلامات واستعادة عناصر سلة المهملات (Trash & Recovery Dao)
 *
 * المسؤوليات المعمارية الحاكمة:
 * 1. استرجاع وحفظ الحزم المحذوفة JSON بصورة غير متزامنة مع دعم التدفقات الحية Flow.
 * 2. عمليات الاستعادة الذرية (@Transaction): تجميع خطوات فك الحزم وإدراج الكيانات المستعادة وحذفها من سلة المهملات في معاملة واحدة غير قابلة للتجزئة لحماية البيانات من الحالات الجزئية عند انقطاع التطبيق.
 */
@Dao
